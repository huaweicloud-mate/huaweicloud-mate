        ...
        template: {
          ...
          imagePullSecrets: [{ name: "swr-secret" }],
           ...
           containers: [{
            ...
            volumeMounts: [{ name: "skills", mountPath: "/skills" }, { name: "workspace", mountPath: "/workspace" }, { name: "tmp", mountPath: "/tmp" }, { name: "hcloud-home", mountPath: "/home/node/.hcloud" }],
          ...
          volumes: [{ name: "skills", emptyDir: {} }, { name: "workspace", emptyDir: {} }, { name: "tmp", emptyDir: {} }, { name: "hcloud-home", emptyDir: {} }],
        },
      },
    },
  };
