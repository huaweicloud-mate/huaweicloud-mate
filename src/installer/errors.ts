export const installerErrorCodes = [
  ...
  "CLAUDE_MARKETPLACE_INVALID",
  "CLAUDE_MARKETPLACE_CONFLICT",
  "CLAUDE_MARKETPLACE_FAILED",
  "CLAUDE_MARKETPLACE_OUTCOME_UNKNOWN",
  "CLAUDE_MARKETPLACE_ROLLBACK_CONFLICT",
  "CLAUDE_ACTIVATION_INVALID",
  "CLAUDE_ACTIVATION_CONFLICT",
  "CLAUDE_ACTIVATION_FAILED",
  "CLAUDE_ACTIVATION_OUTCOME_UNKNOWN",
  "CLAUDE_ACTIVATION_ROLLBACK_CONFLICT",
  "KOOCLI_ARTIFACT_INVALID",
  "KOOCLI_ARCHIVE_INVALID",
  "KOOCLI_INSTALL_INVALID",
  "KOOCLI_INSTALL_CONFLICT",
